...
public class SmorestuffItems {
	...
	public static final Item TRADITIONALSMORE = registerItem("traditional_smore", new Item(new FabricItemSettings().food(SmorestuffFoodComponents.TRADITIONALSMOREFOOD)));
	...
	public static final Item BUCKET_OF_MARSHMALLOW = registerItem("bucket_of_marshmallow", new BucketItem(SmorestuffFluids.MARSHMALLOW_STILL, new FabricItemSettings().maxCount(1)));
	public static final Item MARSHMALLOWEYSMORE = registerItem("marshmallowey_smore", new Item(new FabricItemSettings().food(SmorestuffFoodComponents.CHOCOLATEYSMOREFOOD)));
